...
#define TELINK_AUDIO_UUID_SERVICE  			0x1911		//!< TELINK_SPP service
#define TELINK_MESH_UUID_SERVICE  			0x1920		//!< TELINK_SPP service
#define TELINK_MESH_LT_UUID_SERVICE  		0x1921		//!< TELINK_SPP service
...
#define TELINK_SPP_DATA_OTA 				0x2B12 		//!< TELINK_SPP data for ota
#define TELINK_SPP_DATA_PAIR 				0x2B13 		//!< TELINK_SPP data for ota
#define TELINK_SPP_DATA_DEFINE 				0x2B14		//!< TELINK_SPP data for userdefine data 

#define TELINK_MIC_DATA	 					0x2B18 		//!< TELINK_SPP data from server to client
#define TELINK_SPEAKER_DATA			 		0x2B19 		//!< TELINK_SPP data from client to server
