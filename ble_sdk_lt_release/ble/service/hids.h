...
#define HID_REPORT_ID_MOUSE_IN                          1   //!< Mouse input report ID
#define HID_REPORT_ID_KEY_IN                            2   //!< Keyboard input report ID
#define HID_REPORT_ID_CC_IN                             3   //!< Consumer Control input report ID
