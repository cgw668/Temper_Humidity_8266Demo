...
static u8 bootMouseInReportProp = CHAR_PROP_READ | CHAR_PROP_NOTIFY;
...
/////////////////////////////////////////////////////////
const u16 my_AudioUUID      = TELINK_AUDIO_UUID_SERVICE;
const u16 my_MicUUID		= TELINK_MIC_DATA;
const u16 my_SpeakerUUID	= TELINK_SPEAKER_DATA;
const u16 my_OtaUUID		= TELINK_SPP_DATA_OTA;
...
const attribute_t my_Attributes[] = {
	...
	// Audio 34
	{10,2,2,2,(u8*)(&my_primaryServiceUUID), 	(u8*)(&my_AudioUUID), 0},

	// 35
	{0,2,1,1,(u8*)(&my_characterUUID), 		(u8*)(&my_MicProp), 0},				//prop
	{0,2,1,1,(u8*)(&my_MicUUID), 	(u8*)(&my_MicData), 0},	//value
	...
	{0,2,1,1,(u8*)(&my_SpeakerUUID), 	(u8*)(&my_SpeakerData), &speakerWrite},//value
	...
	{0,2,1,1,(u8*)(&my_OtaUUID),	(&my_OtaData), &otaWrite, &otaRead},			//value
